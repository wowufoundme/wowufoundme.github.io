$(window).ready(function () {
  $(".__loader_wrap").delay(750).fadeTo("fast", 1, function () {
    $(".__loader_wrap").css("transform", "translate3d(100%,0,0)");
    $('.subcontainer').css("transform", "translate3d(0,0,0)");
    $(".__loader_wrap").css("display", "none");
  });
});
